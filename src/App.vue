...
const addedToDo = ref('ciao is vue')

watch(addedToDo, () => console.log('watch - ', addedToDo.value))
...
<template>
  <div :class="'flex flex-col gap-16'">
    <div :class="'flex flex-col justify-center items-center bg-dark-black-custom h-[200px] relative'">
      ...
      <SearchbarButton class='absolute bottom-[-30px]' @sendTodo="(msg) => addedToDo = msg" />
    </div>
    <div :class="'flex flex-col px-padding-container mt-91px'">
      <TableWrapper :todoTo="addedToDo"/>
    </div>
  </div>
</template>
